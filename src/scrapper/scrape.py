...
import os, sys
import time
from selenium.webdriver.chrome.options import Options #to run chrome in headless mode
...
class ScrapeReviews:
    def __init__(self,
        ...
        self.driver = webdriver.Chrome(options=options) # Add the path to your chromedriver if needed
